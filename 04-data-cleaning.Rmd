...
**CAUTION**: editing data in Excel, even using the above approach can lead to unexpected format changes in the data. *SQLite* is a lightweight database platform that connects seamlessly with R. Several open source *SQLite* software packages exist [https://sqlitebrowser.org/] or see [DataChangesDB](https://github.com/HoldenJe/DataChangesDB) for a lightweight custom GUI designed to make FN125 data changes quick and efficient.
